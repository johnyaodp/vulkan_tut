...
void HelloTriangleApplication::pickPhysicalDevice()
{
   ...
   for ( const auto& deviceI : devices )
   {
      if ( isDeviceSuitable( deviceI ) )
      {
         physicalDevice = deviceI;
         break;
      }
   }
...
auto HelloTriangleApplication::isDeviceSuitable(
...
auto HelloTriangleApplication::checkDeviceExtensionSupport(
   VkPhysicalDevice device )
   -> bool
{
...
auto HelloTriangleApplication::findQueueFamilies(
   VkPhysicalDevice device )
   -> QueueFamilyIndices
{
...
auto HelloTriangleApplication::checkValidationLayerSupport()
   -> bool
{
   uint32_t layerCount;
...
auto HelloTriangleApplication::getRequiredExtensions()
